...
```
https://github.com/toss/apps-in-toss-unity-sdk.git#release/v2.4.2
```
...
{
  "dependencies": {
    "im.toss.apps-in-toss-unity-sdk": "https://github.com/toss/apps-in-toss-unity-sdk.git#release/v2.4.2"
  }
}
```
