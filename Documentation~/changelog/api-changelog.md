Apps in Toss Unity SDK가 노출하는 C# API 표면이 `@apps-in-toss/web-framework` 버전에 따라 어떻게 달라지는지 정리한 자동 생성 리포트입니다. 최신 버전(v3.5.0)이 최상단에 오도록 정렬되어 있습니다.

## v3.x

### v3.4.1 → v3.5.0

API 총 133개 · 추가 1 · 변경 0 · 제거 0

**추가된 API**

- `AIT.NavigationBarSetOptions`

### v3.4.0 → v3.4.1

API 총 132개 · 추가 0 · 변경 1 · 제거 0

**변경된 API**

- `AIT.PromotionOpenContactsInvite`: `isDeprecated: false → true`

### v3.3.0 → v3.4.0

API 총 132개 · 추가 1 · 변경 0 · 제거 0
...
API 총 131개 · 추가 2 · 변경 0 · 제거 0

**추가된 API**

- `AIT.ViralGetCampaign`
- `AIT.ViralShare`
...
변경 없음: v3.1.0 → v3.1.1 · v3.0.5 → v3.1.0 · v3.0.4 → v3.0.5 · v3.0.3 → v3.0.4 · v3.0.2 → v3.0.3 · v3.0.1 → v3.0.2
