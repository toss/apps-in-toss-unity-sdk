...
namespace AppsInToss
{
    ...
    public static partial class AIT
    {
        ...
        public static Task ContactsViral(ContactsViralParams paramsParam)
        {
#if UNITY_WEBGL && !UNITY_EDITOR
            var tcs = new TaskCompletionSource<bool>();
            string callbackId = AITCore.Instance.RegisterCallback<object>(_ => tcs.SetResult(true));
            __contactsViral_Internal(paramsParam, callbackId, "void");
            return tcs.Task;
#else
        ...
        private static extern void __contactsViral_Internal(ContactsViralParams paramsParam, string callbackId, string typeName);
#endif
    }
}
