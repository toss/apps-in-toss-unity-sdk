...
namespace AppsInToss
{
    ...
    public static partial class AIT
    {
        ...
        public static Task<string> OpenPermissionDialog(PermissionAccess; permission)
        {
        ...
        private static extern void __openPermissionDialog_Internal(PermissionAccess; permission, string callbackId, string typeName);
#endif
    }
}
