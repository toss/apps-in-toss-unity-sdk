...
namespace AppsInToss
{
    ...
    [Serializable]
    [Preserve]
    public class AdsShowTossAdOrShoppingAdsParams
    {
        [Preserve]
        [JsonProperty("options")]
        public ShowTossAdOrShoppingAdsParams Options;
        [JsonIgnore]
        public System.Action<ShowTossAdOrShoppingAdsEvent> OnEvent;
        [JsonIgnore]
        public System.Action<Error> OnError;
    ...
    [Serializable]
    [Preserve]
    public class ShowTossAdOrShoppingAdsParams
    {
        [Preserve]
        [JsonProperty("spaceUnitId")]
        public string SpaceUnitId;
        [Preserve]
    ...
    [Serializable]
    [Preserve]
    public class ShowTossAdOrShoppingAdsEvent
    {
        [Preserve]
        [JsonProperty("type")]
        public string Type;
        [Preserve]
        [JsonProperty("data")]
        public ShowTossAdOrShoppingAdsEventData Data; // optional
    ...
    [Serializable]
    [Preserve]
    public class ShowTossAdOrShoppingAdsEventData
    {
        [Preserve]
        [JsonProperty("unitType")]
        public string UnitType;
    ...
    [Serializable]
    [Preserve]
    public class AdsShowTossShoppingAdsParams
    {
        [Preserve]
        [JsonProperty("options")]
        public ShowTossShoppingAdsParams Options;
        [JsonIgnore]
        public System.Action<ShowTossShoppingAdsEvent> OnEvent;
        [JsonIgnore]
        public System.Action<Error> OnError;
    ...
    [Serializable]
    [Preserve]
    public class ShowTossShoppingAdsParams
    {
        [Preserve]
        [JsonProperty("adSpaceId")]
        public string AdSpaceId;
    ...
    [Serializable]
    [Preserve]
    public class ShowTossShoppingAdsEvent
    {
        [Preserve]
        [JsonProperty("type")]
        public string Type;
        [Preserve]
        [JsonProperty("data")]
        public ShowTossShoppingAdsEventData Data; // optional
    ...
    [Serializable]
    [Preserve]
    public class ShowTossShoppingAdsEventData
    {
        [Preserve]
        [JsonProperty("unitType")]
        public string UnitType;
