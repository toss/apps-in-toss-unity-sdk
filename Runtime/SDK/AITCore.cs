        ...
        private void RouteCallback(string callbackId, string typeName, string resultJson)
        {
            ...
            switch (typeName)
            {
                ...
                case "Dictionary<ConsentedUserDataKey, string>":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<Dictionary<ConsentedUserDataKey, string>>(callbackId, out var callback7) && callback7 != null)
                        {
                            var data7 = JsonConvert.DeserializeObject<Dictionary<ConsentedUserDataKey, string>>(apiResponse.data);
                            callback7(data7);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback7(new AITException("Dictionary<ConsentedUserDataKey, string>", apiResponse.error));
                        }
                    }
                    break;
                case "GameCenterGameProfileResponse":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<GameCenterGameProfileResponse>(callbackId, out var callback8) && callback8 != null)
                        {
                            var data8 = JsonConvert.DeserializeObject<GameCenterGameProfileResponse>(apiResponse.data);
                            callback8(data8);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback8(new AITException("GameCenterGameProfileResponse", apiResponse.error));
                        }
                    }
                    break;
                case "GetAnonymousKeyResult":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<GetAnonymousKeyResult>(callbackId, out var callback9) && callback9 != null)
                        {
                            var data9 = JsonConvert.DeserializeObject<GetAnonymousKeyResult>(apiResponse.data);
                            callback9(data9);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback9(new AITException("GetAnonymousKeyResult", apiResponse.error));
                        }
                    }
                    break;
                case "GrantPromotionRewardResult":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<GrantPromotionRewardResult>(callbackId, out var callback10) && callback10 != null)
                        {
                            var data10 = JsonConvert.DeserializeObject<GrantPromotionRewardResult>(apiResponse.data);
                            callback10(data10);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback10(new AITException("GrantPromotionRewardResult", apiResponse.error));
                        }
                    }
                    break;
                case "IAPGetPendingOrdersResult":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<IAPGetPendingOrdersResult>(callbackId, out var callback11) && callback11 != null)
                        {
                            var data11 = JsonConvert.DeserializeObject<IAPGetPendingOrdersResult>(apiResponse.data);
                            callback11(data11);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback11(new AITException("IAPGetPendingOrdersResult", apiResponse.error));
                        }
                    }
                    break;
                case "IAPGetProductItemListResult":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<IAPGetProductItemListResult>(callbackId, out var callback12) && callback12 != null)
                        {
                            var data12 = JsonConvert.DeserializeObject<IAPGetProductItemListResult>(apiResponse.data);
                            callback12(data12);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback12(new AITException("IAPGetProductItemListResult", apiResponse.error));
                        }
                    }
                    break;
                case "IapSubscriptionInfoResponse":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<IapSubscriptionInfoResponse>(callbackId, out var callback13) && callback13 != null)
                        {
                            var data13 = JsonConvert.DeserializeObject<IapSubscriptionInfoResponse>(apiResponse.data);
                            callback13(data13);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback13(new AITException("IapSubscriptionInfoResponse", apiResponse.error));
                        }
                    }
                    break;
                case "ImageResponse":
                ...
                case "Location":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<Location>(callbackId, out var callback16) && callback16 != null)
                        {
                            var data16 = JsonConvert.DeserializeObject<Location>(apiResponse.data);
                            callback16(data16);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback16(new AITException("Location", apiResponse.error));
                        }
                    }
                    break;
                case "RequestTossPayPaysBillingResult":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<RequestTossPayPaysBillingResult>(callbackId, out var callback17) && callback17 != null)
                        {
                            var data17 = JsonConvert.DeserializeObject<RequestTossPayPaysBillingResult>(apiResponse.data);
                            callback17(data17);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback17(new AITException("RequestTossPayPaysBillingResult", apiResponse.error));
                        }
                    }
                    break;
                case "SafeAreaInsets":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<SafeAreaInsets>(callbackId, out var callback18) && callback18 != null)
                        {
                            var data18 = JsonConvert.DeserializeObject<SafeAreaInsets>(apiResponse.data);
                            callback18(data18);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback18(new AITException("SafeAreaInsets", apiResponse.error));
                        }
                    }
                    break;
                case "SetScreenAwakeModeResult":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<SetScreenAwakeModeResult>(callbackId, out var callback19) && callback19 != null)
                        {
                            var data19 = JsonConvert.DeserializeObject<SetScreenAwakeModeResult>(apiResponse.data);
                            callback19(data19);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback19(new AITException("SetScreenAwakeModeResult", apiResponse.error));
                        }
                    }
                    break;
                case "SetSecureScreenResult":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<SetSecureScreenResult>(callbackId, out var callback20) && callback20 != null)
                        {
                            var data20 = JsonConvert.DeserializeObject<SetSecureScreenResult>(apiResponse.data);
                            callback20(data20);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback20(new AITException("SetSecureScreenResult", apiResponse.error));
                        }
                    }
                    break;
                case "SubmitGameCenterLeaderBoardScoreResponse":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<SubmitGameCenterLeaderBoardScoreResponse>(callbackId, out var callback21) && callback21 != null)
                        {
                            var data21 = JsonConvert.DeserializeObject<SubmitGameCenterLeaderBoardScoreResponse>(apiResponse.data);
                            callback21(data21);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback21(new AITException("SubmitGameCenterLeaderBoardScoreResponse", apiResponse.error));
                        }
                    }
                    break;
                case "bool?":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<bool?>(callbackId, out var callback22) && callback22 != null)
                        {
                            var data22 = JsonConvert.DeserializeObject<bool?>(apiResponse.data);
                            callback22(data22);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback22(new AITException("bool?", apiResponse.error));
                        }
                    }
                    break;
                case "double?":
                    if (apiResponse.success)
                    {
                        if (TryGetCallback<double?>(callbackId, out var callback23) && callback23 != null)
                        {
                            var data23 = JsonConvert.DeserializeObject<double?>(apiResponse.data);
                            callback23(data23);
                        }
                    }
                    else
                    {
                        ...
                        {
                            errorCallback23(new AITException("double?", apiResponse.error));
                        }
                    }
                    break;
                case "NetworkStatus":
