...
mergeInto(LibraryManager.library, {
    __getOperationalEnvironment_Internal: function() {
        ...
        if (constantHandlerMap && 'getOperationalEnvironment' in constantHandlerMap) {
            return constantHandlerMap['getOperationalEnvironment'];
        }
