...
mergeInto(LibraryManager.library, {
    __getPlatformOS_Internal: function() {
        ...
        if (constantHandlerMap && 'getPlatformOS' in constantHandlerMap) {
            return constantHandlerMap['getPlatformOS'];
        }
        throw new Error('getPlatformOS is not a constant handler');
    },
