...
mergeInto(LibraryManager.library, {
    __getSchemeUri_Internal: function() {
        ...
        if (constantHandlerMap && 'getSchemeUri' in constantHandlerMap) {
            return constantHandlerMap['getSchemeUri'];
        }
        throw new Error('getSchemeUri is not a constant handler');
    },
