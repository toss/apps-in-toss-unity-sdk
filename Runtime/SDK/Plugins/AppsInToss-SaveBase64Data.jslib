/**
 * AppsInToss-SaveBase64Data.jslib
 *
 * 이 파일은 자동 생성되었습니다.
 ...
 * Category: SaveBase64Data
 */

mergeInto(LibraryManager.library, {
    __saveBase64Data_Internal: function(params, callbackId, typeName) {
        ...
        // 응답 리스너 등록
        var removeResolve = emitter.on('saveBase64Data/resolve/' + eventId, function(result) {
            removeResolve();
            removeReject();
        ...
        var removeReject = emitter.on('saveBase64Data/reject/' + eventId, function(error) {
            removeResolve();
            removeReject();
            var payload = JSON.stringify({
                CallbackId: callback,
