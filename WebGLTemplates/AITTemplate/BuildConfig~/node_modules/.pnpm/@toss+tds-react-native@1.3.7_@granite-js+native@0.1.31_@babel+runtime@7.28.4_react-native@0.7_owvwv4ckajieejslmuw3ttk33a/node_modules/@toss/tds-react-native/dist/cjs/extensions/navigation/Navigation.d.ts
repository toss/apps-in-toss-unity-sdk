...
export declare const NavigationIconButton: import("react").ForwardRefExoticComponent<Omit<Pick<import("../../components/icon").IconProps & import("react").RefAttributes<View>, "type" | "name"> & import("react-native").AccessibilityProps & import("react-native").TouchableOpacityProps & import("react").RefAttributes<TouchableOpacity>, "ref"> & import("react").RefAttributes<TouchableOpacity>>;
export {};
