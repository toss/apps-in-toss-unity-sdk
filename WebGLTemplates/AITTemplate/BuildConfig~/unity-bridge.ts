...
const _aitNamespaces = { Analytics, GoogleAdMob, IAP, SafeAreaInsets, Storage, env, graniteEvent, partner, tdsEvent };
...
console.log('[Unity Bridge] Namespaces: Analytics, GoogleAdMob, IAP, SafeAreaInsets, Storage, env, graniteEvent, partner, tdsEvent');
