...
// Ads는 번들 전용 네임스페이스 — 구버전 web-framework/devtools mock에 없을 수 있어
// named import(누락 시 link-time 에러) 대신 방어적으로 접근한다.
const Ads = (WebFramework as Record<string, any>)['Ads'];
...
const _aitNamespaces = { Ads, Analytics, GoogleAdMob, IAP, SafeAreaInsets, Storage, TossAds, env, graniteEvent, partner, tdsEvent };
...
console.log('[Unity Bridge] Namespaces: Ads, Analytics, GoogleAdMob, IAP, SafeAreaInsets, Storage, TossAds, env, graniteEvent, partner, tdsEvent');
