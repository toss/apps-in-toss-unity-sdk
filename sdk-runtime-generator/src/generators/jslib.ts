...
export class JSLibGenerator {
  ...
  private extractNamespace(category: string): string {
    ...
    const namespaceMap: Record<string, string> = {
      Auth: 'window.AppsInToss.auth',
      Payment: 'window.AppsInToss.payment',
      Storage: 'window.AppsInToss.storage',
      Share: 'window.AppsInToss.share',
      Device: 'window.AppsInToss.device',
      Location: 'window.AppsInToss.location',
      Camera: 'window.AppsInToss.camera',
      Ad: 'window.AppsInToss.ad',
    };

    return namespaceMap[category] || 'window.AppsInToss';
  }
