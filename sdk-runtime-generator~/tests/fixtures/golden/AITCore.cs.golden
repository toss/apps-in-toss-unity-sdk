            ...
            if (apiResponse.success)
            {
                switch (typeName)
                {
                    case "LoadAdMobEvent":
                        ...
                        break;
                    case "LoadAdMobInterstitialAdEvent":
                        var data_1 = JsonConvert.DeserializeObject<LoadAdMobInterstitialAdEvent>(apiResponse.data);
                        (rawCallback as Action<LoadAdMobInterstitialAdEvent>)?.Invoke(data_1);
                        break;
                    case "LoadAdMobRewardedAdEvent":
